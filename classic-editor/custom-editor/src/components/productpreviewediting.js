...
export default class ProductPreviewEditing extends Plugin {
  ...
  init() {
    ...
    this.editor.ui.componentFactory.add("insertProduct", locale => {
      // const dropdownView =
      ...
      dropdownView.on( 'change', (evt, propertyName, newValue, oldValue) => {
      ...
      dropdownView.buttonView.on( 'change', (evt, propertyName, newValue, oldValue) => {
      ...
      dropdownView.panelView.on( 'change', (evt, propertyName, newValue, oldValue) => {
        console.log('panel change');
        console.log(evt, propertyName, newValue, oldValue);
        console.log('--------');

        this.editor.execute( 'insertProduct', 1 );
